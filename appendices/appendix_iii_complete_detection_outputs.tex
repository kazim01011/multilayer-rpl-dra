...
This appendix expands the compressed result table in the manuscript. It explains the metrics, reports the complete held-out-seed table, and discusses what the confusion matrix and precision--recall--FPR figure mean for DRA detection.
